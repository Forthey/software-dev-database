...
# my config to get URL
from config import settings
# need to import all models files to load metadata correctly
...
# set database url
config.set_main_option('sqlalchemy.url', settings.get_psycopg_URL + "?async_fallback=True")
